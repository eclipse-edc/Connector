...
### Extension points
  - `org.eclipse.edc.jsonld.cache.spi.resolver.JsonLdContextResolver`
  - `org.eclipse.edc.jsonld.cache.spi.store.CachedJsonLdContextStore`
  - `org.eclipse.edc.jsonld.cache.spi.CachedJsonLdContextService`
...
Module `json-ld-cache-api`
--------------------------
**Artifact:** org.eclipse.edc:json-ld-cache-api:0.19.0-SNAPSHOT
...
### Extensions
#### Class: `org.eclipse.edc.jsonld.cache.api.JsonLdContextCacheApiExtension`
**Name:** "Management API: JSON-LD Context Cache"
...
#### Referenced (injected) services
- `org.eclipse.edc.web.spi.WebService` (required)
- `org.eclipse.edc.jsonld.cache.spi.CachedJsonLdContextService` (required)
- `org.eclipse.edc.transform.spi.TypeTransformerRegistry` (required)
- `org.eclipse.edc.jsonld.spi.JsonLd` (required)
- `org.eclipse.edc.spi.types.TypeManager` (required)
- `org.eclipse.edc.validator.spi.JsonObjectValidatorRegistry` (required)

Module `json-ld-cache-core`
---------------------------
**Artifact:** org.eclipse.edc:json-ld-cache-core:0.19.0-SNAPSHOT
...
### Extensions
#### Class: `org.eclipse.edc.jsonld.cache.JsonLdContextCacheDefaultServicesExtension`
**Name:** "JSON-LD Context Cache Default Services"

**Overview:**  Provides the {@link CachedJsonLdContextService}, synchronizes the persisted cache into the {@link JsonLd}
...
#### Class: `org.eclipse.edc.jsonld.cache.JsonLdContextCacheExtension`
**Name:** "JSON-LD Context Cache"
...
| Key                                    | Required | Type     | Default   | Pattern | Min | Max | Description                                                                                                     |
| -------------------------------------- | -------- | -------- | --------- | ------- | --- | --- | --------------------------------------------------------------------------------------------------------------- |
| `edc.jsonld.cache.refresh.enabled`     | `*`      | `string` | `true`    |         |     |     | Enables the background refresh of cached JSON-LD contexts                                                       |
| `edc.jsonld.cache.refresh.interval.ms` | `*`      | `string` | `3600000` |         |     |     | Interval (in milliseconds) between background refreshes of cached JSON-LD contexts with pull strategy 'always'. |
...
#### Referenced (injected) services
- `org.eclipse.edc.jsonld.spi.JsonLd` (required)
- `org.eclipse.edc.jsonld.cache.spi.store.CachedJsonLdContextStore` (required)
- `org.eclipse.edc.jsonld.cache.spi.resolver.JsonLdContextResolver` (required)
- `org.eclipse.edc.transaction.spi.TransactionContext` (required)
- `org.eclipse.edc.spi.system.ExecutorInstrumentation` (required)
- `java.time.Clock` (required)

Module `json-ld-cache-store-sql`
--------------------------------
**Artifact:** org.eclipse.edc:json-ld-cache-store-sql:0.19.0-SNAPSHOT

**Categories:** _None_

### Extension points
  - `org.eclipse.edc.jsonld.cache.store.sql.schema.CachedJsonLdContextStoreStatements`

### Extensions
#### Class: `org.eclipse.edc.jsonld.cache.store.sql.SqlCachedJsonLdContextStoreExtension`
**Name:** "SQL cached JSON-LD context store"
...
| Key                                    | Required | Type     | Default   | Pattern | Min | Max | Description               |
| -------------------------------------- | -------- | -------- | --------- | ------- | --- | --- | ------------------------- |
| `edc.sql.store.jsonldcache.datasource` | `*`      | `string` | `default` |         |     |     | The datasource to be used |
...
- `org.eclipse.edc.transaction.datasource.spi.DataSourceRegistry` (required)
- `org.eclipse.edc.transaction.spi.TransactionContext` (required)
- `org.eclipse.edc.jsonld.cache.store.sql.schema.CachedJsonLdContextStoreStatements` (optional)
- `org.eclipse.edc.spi.types.TypeManager` (required)
- `org.eclipse.edc.sql.QueryExecutor` (required)
- `org.eclipse.edc.sql.bootstrapper.SqlSchemaBootstrapper` (required)
