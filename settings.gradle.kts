...
include(":core:control-plane:partner-cel")
...
include(":extensions:control-plane:api:management-api-v5:partner-api-v5")
...
include(":extensions:control-plane:api:management-api-v5:data-plane-selector-api-v5")
...
include(":extensions:control-plane:store:sql:partner-store-sql")
