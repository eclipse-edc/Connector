...
include(":extensions:common:vault:hashicorp")
include(":extensions:common:vault:hashicorp:vault-hashicorp-spi")
include(":extensions:common:vault:hashicorp:vault-hashicorp")
