 ...
 */
public class DeprovisionResult extends AbstractResult<DeprovisionResponse, ResponseFailure> {

    public static DeprovisionResult success(DeprovisionResponse response) {
        return new DeprovisionResult(response, null);
    }
    ...
    private DeprovisionResult(DeprovisionResponse response, ResponseFailure failure) {
