...
/**
 * A registry of {@link TransferManager}s.
 */
public interface TransferManagerRegistry {
    ...
    /**
     * Returns the transfer manager if one is registered that can handle the data represented by the urn; otherwise null if no manager is found.
     *
