...
public interface Provisioner<RD extends ResourceDefinition, PR extends ProvisionedResource> {
     ...
     * {@link org.eclipse.edc.spi.transfer.response.ResponseStatus#ERROR_RETRY}. If an exception occurs and re-tries should not be re-attempted, return
     * {@link org.eclipse.edc.spi.transfer.response.ResponseStatus#FATAL_ERROR}.
     */
