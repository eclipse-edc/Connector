 ...
 * @param trustedIssuers       List of the trusted issuers.
 */
public record DataspaceProfileContext(String name,
    ...
    public static final String DATASPACE_PROFILE_CONTEXT_TRUSTED_ISSUERS_TERM = "trustedIssuers";
    public static final String DATASPACE_PROFILE_CONTEXT_TRUSTED_ISSUERS_IRI = EDC_NAMESPACE + DATASPACE_PROFILE_CONTEXT_TRUSTED_ISSUERS_TERM;
