...
public interface VerifiableCredentialValidationService {
     ...
     *     <li>Valid issuer: the issuer of every credential is checked against a list of trusted issuers.</li>
     * </ul>
     *
     ...
     * @param dataspaceProfileContext The Dataspace profile context.
     * @return {@link Result#success()} if (and only if) every presentation and every credential are determined to be valid.
     */
    Result<Void> validate(List<VerifiablePresentationContainer> presentations, String audience, DataspaceProfileContext dataspaceProfileContext);
}
