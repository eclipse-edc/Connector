 ...
 * This class extends {@link JsonLdToModelTransformer} and provides additional functionality
 ...
 */
public abstract class NamespacedJsonLdToModelTransformer<INPUT, OUTPUT> extends JsonLdToModelTransformer<INPUT, OUTPUT> {

    private final JsonLdNamespace namespace;

    protected NamespacedJsonLdToModelTransformer(Class<INPUT> input, Class<OUTPUT> output, JsonLdNamespace namespace) {
        super(input, output);
