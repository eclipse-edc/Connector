...
package org.eclipse.edc.document.cache.spi.store;
...
/**
 * Persists {@link CachedDocument} entries. Implementations must be thread-safe.
 */
@ExtensionPoint
public interface CachedDocumentStore {

    String NOT_FOUND = "Cached document with ID %s could not be found";
    String ALREADY_EXISTS = "Cached document with ID %s already exists";
    String URL_ALREADY_EXISTS = "Cached document with URL %s already exists";
     ...
     * @throws EdcPersistenceException if something goes wrong.
     */
    CachedDocument findByUrl(String url);
     ...
     * @throws EdcPersistenceException if something goes wrong.
     */
    Stream<CachedDocument> findAll(QuerySpec spec);
     ...
     */
    StoreResult<CachedDocument> create(CachedDocument context);
     ...
     */
    StoreResult<CachedDocument> update(CachedDocument context);
     ...
     */
    StoreResult<CachedDocument> delete(String id);
