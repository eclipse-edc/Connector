...
public interface ProviderContractNegotiationManager extends ContractNegotiationManager {
     ...
     */
    NegotiationResult requested(ClaimToken token, ContractOfferMessage request);

    /**
     * A new offer was made by the consumer represented by the claim token.
     */
    NegotiationResult offerReceived(ClaimToken token, ContractOffer offer, String hash);
     ...
     */
    NegotiationResult consumerApproved(ClaimToken token, String correlationMessageId, ContractAgreement agreement, String hash);
