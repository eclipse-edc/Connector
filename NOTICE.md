...
SLF4J API Module
* Project: http://www.slf4j.org
* Maven Artifact: org.slf4j/slf4j-api/2.0.5
* License: MIT

SLF4J API Module
* Project: http://www.slf4j.org
* Maven Artifact: org.slf4j/slf4j-api/2.0.6
* License: MIT

ThreeTen backport
* Project: https://www.threeten.org/threetenbp
* Source: scm:git:https://github.com/ThreeTen/threetenbp.git
* Maven Artifact: org.threeten/threetenbp/1.6.1
* License: BSD-3-Clause

ThreeTen backport
* Project: https://www.threeten.org/threetenbp
* Source: scm:git:https://github.com/ThreeTen/threetenbp.git
* Maven Artifact: org.threeten/threetenbp/1.6.5
* License: BSD-3-Clause

org.xmlunit:xmlunit-core
* Project: https://www.xmlunit.org/
* Maven Artifact: org.xmlunit/xmlunit-core/2.9.1
* License: Apache-2.0

org.xmlunit:xmlunit-placeholders
* Maven Artifact: org.xmlunit/xmlunit-placeholders/2.9.1
* License: Apache-2.0

SnakeYAML
* Project: https://bitbucket.org/snakeyaml/snakeyaml
* Source: scm:git:http://bitbucket.org/snakeyaml/snakeyaml
* Maven Artifact: org.yaml/snakeyaml/1.33
* License: Apache-2.0

AWS Java SDK :: Annotations
* Maven Artifact: software.amazon.awssdk/annotations/2.19.26
* License: Apache-2.0

AWS Java SDK :: HTTP Clients :: Apache
* Maven Artifact: software.amazon.awssdk/apache-client/2.19.26
* License: Apache-2.0

AWS Java SDK :: Arns
* Project: https://aws.amazon.com/sdkforjava
* Maven Artifact: software.amazon.awssdk/arns/2.19.26
* License: Apache-2.0
...
* Project: https://aws.amazon.com/sdkforjava
* Maven Artifact: software.amazon.awssdk/aws-core/2.19.26
* License: Apache-2.0

AWS Java SDK :: Core :: Protocols :: AWS Json Protocol
* Project: https://aws.amazon.com/sdkforjava
* Maven Artifact: software.amazon.awssdk/aws-json-protocol/2.19.26
* License: Apache-2.0

AWS Java SDK :: Core :: Protocols :: AWS Query Protocol
* Project: https://aws.amazon.com/sdkforjava
* Maven Artifact: software.amazon.awssdk/aws-query-protocol/2.19.26
* License: Apache-2.0

AWS Java SDK :: Core :: Protocols :: AWS Xml Protocol
* Project: https://aws.amazon.com/sdkforjava
* Maven Artifact: software.amazon.awssdk/aws-xml-protocol/2.19.26
* License: Apache-2.0

AWS Java SDK :: Endpoints SPI
* Maven Artifact: software.amazon.awssdk/endpoints-spi/2.19.26
* License: Apache-2.0

AWS Java SDK :: HTTP Client Interface
* Maven Artifact: software.amazon.awssdk/http-client-spi/2.19.26
* License: Apache-2.0

AWS Java SDK :: Services :: AWS IAM
* Project: https://aws.amazon.com/sdkforjava
* Maven Artifact: software.amazon.awssdk/iam/2.19.26
* License: Apache-2.0

AWS Java SDK :: Core :: Protocols :: Json Utils
* Project: https://aws.amazon.com/sdkforjava
* Maven Artifact: software.amazon.awssdk/json-utils/2.19.26
* License: Apache-2.0

AWS Java SDK :: Metrics SPI
* Maven Artifact: software.amazon.awssdk/metrics-spi/2.19.26
* License: Apache-2.0

AWS Java SDK :: HTTP Clients :: Netty Non-Blocking I/O
* Maven Artifact: software.amazon.awssdk/netty-nio-client/2.19.26
* License: Apache-2.0

AWS Java SDK :: Profiles
* Project: https://aws.amazon.com/sdkforjava
* Maven Artifact: software.amazon.awssdk/profiles/2.19.26
* License: Apache-2.0

AWS Java SDK :: Core :: Protocols :: Protocol Core
* Project: https://aws.amazon.com/sdkforjava
* Maven Artifact: software.amazon.awssdk/protocol-core/2.19.26
* License: Apache-2.0

AWS Java SDK :: Regions
* Maven Artifact: software.amazon.awssdk/regions/2.19.26
* License: Apache-2.0

AWS Java SDK :: Services :: Amazon S3
* Project: https://aws.amazon.com/sdkforjava
* Maven Artifact: software.amazon.awssdk/s3/2.19.26
* License: Apache-2.0

AWS Java SDK :: SDK Core
* Project: https://aws.amazon.com/sdkforjava
* Maven Artifact: software.amazon.awssdk/sdk-core/2.19.26
* License: Apache-2.0

AWS Java SDK :: Services :: AWS Secrets Manager
* Project: https://aws.amazon.com/sdkforjava
* Maven Artifact: software.amazon.awssdk/secretsmanager/2.19.26
* License: Apache-2.0

AWS Java SDK :: Services :: AWS STS
* Project: https://aws.amazon.com/sdkforjava
* Maven Artifact: software.amazon.awssdk/sts/2.19.26
* License: Apache-2.0

AWS Java SDK :: Third Party :: Jackson-core
* Project: https://aws.amazon.com/sdkforjava
* Maven Artifact: software.amazon.awssdk/third-party-jackson-core/2.19.26
* License: Apache-2.0

AWS Java SDK :: Utilities
* Maven Artifact: software.amazon.awssdk/utils/2.19.26
* License: Apache-2.0
