...
public class AssetApiController implements AssetApi {
    ...
    @GET
    @Override
    public List<AssetOutputDto> getAllAssets(@Valid @BeanParam QuerySpecDto querySpecDto) {
        ...
        return assets.stream()
                .map(it -> transformerRegistry.transform(it, AssetOutputDto.class))
    ...
    @Path("{id}")
    @Override
    public AssetOutputDto getAsset(@PathParam("id") String id) {
