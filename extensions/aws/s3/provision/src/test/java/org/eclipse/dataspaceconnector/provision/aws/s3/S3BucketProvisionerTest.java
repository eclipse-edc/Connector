...
class S3BucketProvisionerTest {
    ...
    void setUp() {
        ...
        provisioner = new S3BucketProvisioner(clientProvider, 3600, new Monitor() {
        }, new RetryPolicy<>());
    }
    ...
    @Test
    void should_return_errored_resource_on_error() {
        ...
        assertThat(response.getResource().isError()).isTrue();
        assertThat(response.getSecretToken()).isNull();
    }
