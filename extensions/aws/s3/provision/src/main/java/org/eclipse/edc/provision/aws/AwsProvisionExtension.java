...
package org.eclipse.edc.provision.aws;

import net.jodah.failsafe.RetryPolicy;
import org.eclipse.edc.provision.aws.provider.ClientProvider;
import org.eclipse.edc.provision.aws.provider.SdkClientProvider;
import org.eclipse.edc.provision.aws.s3.*;
...
/**
 * Provides data transfer {@link org.eclipse.edc.spi.transfer.provision.Provisioner}s backed by AWS services.
 */
public class AwsProvisionExtension implements ServiceExtension {
    ...
    public Set<String> requires() {
        return Set.of("edc:retry-policy", "edc:statuschecker");
    }

    @Override
    public Set<String> provides() {
        return Set.of("edc:clientprovider");
    }
