...
public class ProvisionHttpResourceProvisioner implements Provisioner {

    private final ProvisionHttpClient provisionHttpClient;

    public ProvisionHttpResourceProvisioner(ProvisionHttpClient provisionHttpClient) {
    ...
    public CompletableFuture<StatusResult<ProvisionedResource>> provision(ProvisionResource provisionResource) {
        return CompletableFuture.completedFuture(provisionHttpClient.provision(provisionResource));
    }
}
