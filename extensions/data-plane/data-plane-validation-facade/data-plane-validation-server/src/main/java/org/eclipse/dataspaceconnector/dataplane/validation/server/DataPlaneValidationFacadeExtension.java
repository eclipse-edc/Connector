...
public class DataPlaneValidationFacadeExtension implements ServiceExtension {
    ...
    public void initialize(ServiceExtensionContext context) {
        ...
        var publicKey = extractPublicKey(context);
        var tokenValidationService = new TokenValidationServiceImpl(id -> publicKey, validationRules);
        var webService = context.getService(WebService.class);
        webService.registerResource(VALIDATION, new DataPlaneValidationFacadeController(tokenValidationService));
    }
