...
public class DataPlaneHttpIntegrationTests {
    ...
    private static final DataPlaneAuthorizationService DATAPLANE_AUTH_SERVICE = mock();
    ...
    ).registerServiceMock(DataPlaneAuthorizationService.class, DATAPLANE_AUTH_SERVICE);
