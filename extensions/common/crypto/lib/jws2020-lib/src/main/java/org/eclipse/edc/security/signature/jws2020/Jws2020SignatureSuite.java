...
public final class Jws2020SignatureSuite implements SignatureSuite {
    ...
    private ProofValue getProofValue(String proofValue) {
        return proofValue != null ? new SolidProofValue(proofValue.getBytes()) : null;
    }
}
