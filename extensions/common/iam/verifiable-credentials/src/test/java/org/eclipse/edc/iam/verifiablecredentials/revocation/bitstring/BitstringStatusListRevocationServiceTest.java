...
class BitstringStatusListRevocationServiceTest {
    ...
    @Test
    void downloadStatusListCredential_asJwt_callTokenValidationService() throws Exception {
        ...
        var acceptJwtService = new BitstringStatusListRevocationService(mapper, 5 * 60 * 1000,
