...
public class SelfIssueIdTokenValidationActionComponentTest {
    ...
    @Test
    void verify(ServiceExtensionContext context, DcpCoreExtension extension) throws JOSEException {
        extension.initialize(context);
    ...
    @Test
    void verify_whenIssuerMismatchKid(ServiceExtensionContext context, DcpCoreExtension extension) throws JOSEException {
        extension.initialize(context);
    ...
    @Test
    void verify_whenIssuerMismatchSubject(ServiceExtensionContext context, DcpCoreExtension extension) throws JOSEException {
        extension.initialize(context);
    ...
    @Test
    void verify_whenUnexpectedAudience(ServiceExtensionContext context, DcpCoreExtension extension) throws JOSEException {
        extension.initialize(context);
    ...
    @Test
    void verify_whenMissingAccessToken(ServiceExtensionContext context, DcpCoreExtension extension) throws JOSEException {
        extension.initialize(context);
    ...
    @Test
    void verify_whenMissingExpiration(ServiceExtensionContext context, DcpCoreExtension extension) throws JOSEException {
        extension.initialize(context);
    ...
    @Test
    void verify_whenSubJwkIsNotNull(ServiceExtensionContext context, DcpCoreExtension extension) throws JOSEException {
        extension.initialize(context);
