...
@Extension(value = CachedDocumentApiExtension.NAME)
public class CachedDocumentApiExtension implements ServiceExtension {

    public static final String NAME = "Management API: Document Cache";
    ...
    public void initialize(ServiceExtensionContext context) {
        ...
        managementApiTransformerRegistry.register(new JsonObjectToCachedDocumentTransformer());
        managementApiTransformerRegistry.register(new JsonObjectFromCachedDocumentTransformer(factory));
