...
class JsonObjectToCachedJsonLdContextTransformerTest {
    ...
    void setUp() {
        ...
        registry.register(new JsonObjectToCachedJsonLdContextTransformer());
    }
    ...
    void shouldTransformToEntity() {
        var jsonObject = jsonFactory.createObjectBuilder()
                ...
                .add(TYPE, CACHED_JSON_LD_CONTEXT_TYPE_TERM)
        ...
        var result = registry.transform(TestJsonLd.expand(jsonObject), CachedJsonLdContext.class);
