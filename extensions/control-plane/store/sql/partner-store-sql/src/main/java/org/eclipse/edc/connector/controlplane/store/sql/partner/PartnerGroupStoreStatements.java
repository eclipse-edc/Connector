...
/**
 * Statement templates and column names for the partner group table.
 */
public interface PartnerGroupStoreStatements extends SqlStatements {

    default String getPartnerGroupTable() {
        return "edc_partner_group";
    }
