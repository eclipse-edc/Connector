...
public class SqlDataspaceProfileStoreExtensionTest {
    ...
    @Test
    void shouldInitializeTheStore(SqlDataspaceProfileStoreExtension extension, ServiceExtensionContext context) {
        ...
        var service = context.getService(DataspaceProfileStore.class);
        assertThat(service).isInstanceOf(SqlDataspaceProfileStore.class);
    }
}
