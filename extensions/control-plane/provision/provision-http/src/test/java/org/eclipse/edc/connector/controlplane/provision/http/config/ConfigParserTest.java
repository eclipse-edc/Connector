...
import static org.eclipse.edc.connector.controlplane.provision.http.config.ConfigParser.parseConfigurations;

class ConfigParserTest {

    @Test
    void verifyParse() {
        var config = ConfigFactory.fromMap(HttpProvisionerFixtures.PROVISIONER_CONFIG);
        ...
        assertThat(configuration.getDataAddressType()).isEqualTo(HttpProvisionerFixtures.TEST_DATA_TYPE);
    }
