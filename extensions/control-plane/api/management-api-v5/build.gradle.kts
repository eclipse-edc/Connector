...
dependencies {
    ...
    api(project(":extensions:control-plane:api:management-api-v5:partner-api-v5"))
    ...
    api(project(":extensions:control-plane:api:management-api-v5:data-plane-selector-api-v5"))
}
