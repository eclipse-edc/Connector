...
@OpenAPIDefinition(info = @Info(title = "ParticipantContext config Management API", version = "v5"))
@Tag(name = "Participant Context config v5")
public interface ParticipantContextConfigApiV5 {
    ...
    void patchConfigV5(String participantContextId, JsonObject participantContext);
