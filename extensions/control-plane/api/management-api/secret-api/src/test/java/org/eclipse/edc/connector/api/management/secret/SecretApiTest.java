...
import static org.eclipse.edc.connector.api.management.secret.SecretApi.SecretInputSchema.SECRET_INPUT_EXAMPLE;
import static org.eclipse.edc.connector.api.management.secret.SecretApi.SecretOutputSchema.SECRET_OUTPUT_EXAMPLE;
...
class SecretApiTest {
    ...
    void secretInputExample() throws JsonProcessingException {
        var validator = SecretValidator.instance();
