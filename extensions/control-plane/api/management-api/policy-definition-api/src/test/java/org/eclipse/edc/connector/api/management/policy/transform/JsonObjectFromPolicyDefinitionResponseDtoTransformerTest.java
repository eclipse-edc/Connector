...
import static org.eclipse.edc.jsonld.spi.PropertyAndTypeNames.EDC_POLICY_DEFINITION_TYPE;
...
class JsonObjectFromPolicyDefinitionResponseDtoTransformerTest {

    private final JsonObjectFromPolicyDefinitionResponseDtoTransformer transformer = new JsonObjectFromPolicyDefinitionResponseDtoTransformer(Json.createBuilderFactory(emptyMap()));
    private final TransformerContext context = mock(TransformerContext.class);

    @Test
    void types() {
        assertThat(transformer.getInputType()).isEqualTo(PolicyDefinitionResponseDto.class);
    ...
    void transform() {
        ...
        var input = PolicyDefinitionResponseDto.Builder.newInstance().id("definitionId").policy(policy).build();
