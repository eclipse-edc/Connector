...
class JsonObjectToPolicyDefinitionRequestDtoTransformerTest {

    private final JsonObjectToPolicyDefinitionRequestDtoTransformer transformer = new JsonObjectToPolicyDefinitionRequestDtoTransformer();
    private final TransformerContext context = mock(TransformerContext.class);

    @Test
    void types() {
        assertThat(transformer.getInputType()).isEqualTo(JsonObject.class);
        assertThat(transformer.getOutputType()).isEqualTo(PolicyDefinitionRequestDto.class);
    }
