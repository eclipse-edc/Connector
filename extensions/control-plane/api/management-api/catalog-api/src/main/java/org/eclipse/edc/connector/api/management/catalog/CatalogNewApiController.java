...
public class CatalogNewApiController implements CatalogNewApi {

    private final CatalogService service;
    private final TypeTransformerRegistry transformerRegistry;
    private final JsonLd jsonLd;

    public CatalogNewApiController(CatalogService service, TypeTransformerRegistry transformerRegistry, JsonLd jsonLd) {
