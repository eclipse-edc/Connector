...
class SecretsApiControllerTest extends RestControllerTestBase {
    ...
    protected Object controller() {
        return new SecretsApiController(service, transformerRegistry, validator);
    }
