...
@Schema(example = DataPlaneInstanceSchemaV3.DATAPLANE_INSTANCE_EXAMPLE)
public record DataPlaneInstanceSchemaV3(
        ...
        @Schema(requiredMode = REQUIRED, deprecated = true)
