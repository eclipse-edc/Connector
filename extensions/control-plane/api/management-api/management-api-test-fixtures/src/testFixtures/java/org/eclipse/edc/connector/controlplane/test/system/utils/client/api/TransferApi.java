...
public class TransferApi {
    ...
    public String initTransfer(String participantContextId, TransferRequestDto transferRequest) {
        return connector.baseManagementRequest(participantContextId)
                ...
                .when()
                .post("/v5/participants/%s/transferprocesses".formatted(participantContextId))
                .then()
    ...
    public String getState(String participantContextId, String transferId) {
        return connector.baseManagementRequest(participantContextId)
                .contentType(JSON)
                .when()
                .get("/v5/participants/%s/transferprocesses/%s/state".formatted(participantContextId, transferId))
                .then()
                .log().ifValidationFails()
                .statusCode(200)
                .contentType(JSON)
    ...
    public TransferProcessDto getTransferProcess(String participantContextId, String transferId) {
        return connector.baseManagementRequest(participantContextId)
                .contentType(JSON)
                .when()
                .get("/v5/participants/%s/transferprocesses/%s".formatted(participantContextId, transferId))
                .then()
                .log().ifValidationFails()
                .statusCode(200)
                .contentType(JSON)
    ...
    public void suspendTransfer(String participantContextId, String transferId, String reason) {
        ...
        connector.baseManagementRequest(participantContextId)
                ...
                .when()
                .post("/v5/participants/%s/transferprocesses/%s/suspend".formatted(participantContextId, transferId))
                .then()
                .log().ifValidationFails()
                .statusCode(204);
    ...
    public void terminateTransfer(String participantContextId, String transferId, String reason) {
        ...
        connector.baseManagementRequest(participantContextId)
                ...
                .when()
                .post("/v5/participants/%s/transferprocesses/%s/terminate".formatted(participantContextId, transferId))
                .then()
                .log().ifValidationFails()
                .statusCode(204);
    ...
    public void resumeTransfer(String participantContextId, String transferId) {
        connector.baseManagementRequest(participantContextId)
                .contentType(JSON)
                .when()
                .post("/v5/participants/%s/transferprocesses/%s/resume".formatted(participantContextId, transferId))
                .then()
                .log().ifValidationFails()
                .statusCode(204);
