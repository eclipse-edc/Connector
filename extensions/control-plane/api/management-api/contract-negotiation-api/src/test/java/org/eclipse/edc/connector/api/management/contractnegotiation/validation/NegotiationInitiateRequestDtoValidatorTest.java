...
class NegotiationInitiateRequestDtoValidatorTest {

    private final Validator<JsonObject> validator = NegotiationInitiateRequestDtoValidator.instance();
    ...
    void shouldSuccess_whenObjectIsValid() {
        var input = Json.createObjectBuilder()
                ...
                .add(CONNECTOR_ID, value("connector-id"))
    ...
    void shouldFail_whenMandatoryPropertiesAreMissing() {
        ...
        assertThat(result).isFailed().extracting(ValidationFailure::getViolations).asInstanceOf(list(Violation.class))
                ...
                .anySatisfy(violation -> assertThat(violation.path()).isEqualTo(CONNECTOR_ID))
