...
package org.eclipse.edc.catalog.atlas.dto;
...
public class AtlasRelationshipDef extends AtlasStructDef implements java.io.Serializable {
     ...
     * @param typeVersion          - version - that defaults to 1.0
     * @param relationshipCategory - there are 3 sorts of relationship category ASSOCIATION, COMPOSITION
     *                             and AGGREGATION
     * @param propagatetags        -
     * @param endDef1              - first end. An end specifies an entity type and an attribute name. the attribute name then appears in
     *                             the relationship instance
     * @param endDef2              - second end. An end specifies an entity type and an attribute name. the attribute name then appears in
     *                             the relationship instance
     *                             <p>
     ...
     *                             and AGGREGATION
     * @param propagatetags        -
     * @param endDef1              - First end. As end specifies an entity
     *                             type and an attribute name. the attribute name then appears in
     *                             the relationship instance
     * @param endDef2              - Second end. The ends are defined as 1
     *                             ad 2 to avoid implying a direction. So we do not use to and
     *                             from.
     * @param attributeDefs        - these are the attributes on the relationship itself.
     */
    public AtlasRelationshipDef(String name, String description, String typeVersion,
                                AtlasRelationshipDef.RelationshipCategory relationshipCategory,
                                AtlasRelationshipDef.PropagateTags propagatetags, AtlasRelationshipEndDef endDef1,
    ...
    public AtlasRelationshipDef.RelationshipCategory getRelationshipCategory() {
        return relationshipCategory;
    }

    public void setRelationshipCategory(AtlasRelationshipDef.RelationshipCategory relationshipCategory) {
    ...
    public StringBuilder toString(StringBuilder sb) {
        ...
        sb.append(',');
        sb.append(relationshipLabel);
        sb.append(',');
        sb.append(propagateTags);
        sb.append(',');
        if (endDef1 != null) {
            sb.append(endDef1.toString());
        } else {
            sb.append(" end1 is null!");
        }
        sb.append(',');
        if (endDef2 != null) {
            sb.append(endDef2.toString());
        } else {
