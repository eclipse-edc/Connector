...
package org.eclipse.dataspaceconnector.transfer.sync.provider;
...
import org.eclipse.dataspaceconnector.transfer.sync.provider.flow.HttpProviderProxyDataFlowController;
import org.eclipse.dataspaceconnector.transfer.sync.provider.provision.HttpProviderProxyProvisionedResource;
import org.eclipse.dataspaceconnector.transfer.sync.provider.provision.HttpProviderProxyProvisioner;
import org.eclipse.dataspaceconnector.transfer.sync.provider.provision.HttpProviderProxyResourceDefinition;
import org.eclipse.dataspaceconnector.transfer.sync.provider.provision.HttpProviderProxyResourceGenerator;
import org.eclipse.dataspaceconnector.transfer.sync.provider.provision.HttpProviderProxyStatusChecker;
import org.eclipse.dataspaceconnector.transfer.sync.provider.schema.HttpProxySchema;
...
public class SyncDataTransferProviderExtension implements ServiceExtension {
    ...
    @EdcSetting
    private static final String PROVIDER_DATA_API_AUTH_KEY = "edc.transfer.sync.data-api.auth-key";
    private static final String DEFAULT_PROVIDER_DATA_API_AUTH_KEY = "Authorization";
    ...
    public void initialize(ServiceExtensionContext context) {
        ...
        statusCheckerReg.register(HttpProxySchema.TYPE, new HttpProviderProxyStatusChecker());
    ...
    private void registerDataFlowController(ServiceExtensionContext context) {
        ...
        var proxyAuthKey = context.getSetting(PROVIDER_DATA_API_AUTH_KEY, DEFAULT_PROVIDER_DATA_API_AUTH_KEY);
        dataFlowManager.register(new HttpProviderProxyDataFlowController(context.getConnectorId(), proxyAuthKey, dispatcherRegistry));
    }
}
