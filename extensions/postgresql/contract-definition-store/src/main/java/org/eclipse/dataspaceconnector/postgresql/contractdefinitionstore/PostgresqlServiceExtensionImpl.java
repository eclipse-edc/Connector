...
import org.eclipse.dataspaceconnector.postgresql.contractdefinitionstore.settings.CommonsConnectionPoolConfigFactory;
import org.eclipse.dataspaceconnector.postgresql.contractdefinitionstore.settings.ConnectionFactoryConfigFactory;
...
public class PostgresqlServiceExtensionImpl implements ServiceExtension {
    ...
    private static final String NAME = "PostgreSql Contract Definition Store Service Extension";
    ...
    public void initialize(ServiceExtensionContext context) {
        ...
        ContractDefinitionStore contractDefinitionStore = createContractDefinitionStore(context);
    ...
    @NotNull
    private ContractDefinitionStore createContractDefinitionStore(ServiceExtensionContext context) {
        ...
        return new ContractDefinitionStoreImpl(assetRepository);
    }
}
