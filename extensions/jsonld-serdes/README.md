...
This extension provides implementations for (de-)serialization. The `JsonldService` class provides
...
Classes, that should use the `JsonLdSerializer` need to be registered, e.g.:
