...
### XII. Observability
1. Services are [instrumented for collecting essential metrics](IdeaProjects/EclipseDataspaceConnector/docs/developer/metrics.md), in particular instances of `ExecutorService`.
