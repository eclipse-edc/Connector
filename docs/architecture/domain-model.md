...
![domain-model](IdeaProjects/EclipseDataspaceConnector/docs/diagrams/domain-model.png)
...
provided in a separate [section](IdeaProjects/EclipseDataspaceConnector/docs/Policies.md).
