...
![UML Sequence Diagram](IdeaProjects/EclipseDataspaceConnector/docs/architecture/data-transfer/description-request-flow.png)
...
![UML Sequence Diagram](IdeaProjects/EclipseDataspaceConnector/docs/architecture/data-transfer/data-flow-http-push.png)
