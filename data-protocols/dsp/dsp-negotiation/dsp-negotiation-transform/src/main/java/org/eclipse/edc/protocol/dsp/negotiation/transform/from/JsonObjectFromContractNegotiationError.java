 ...
 */
public class JsonObjectFromContractNegotiationError extends AbstractJsonLdTransformer<ContractNegotiationError, JsonObject> {

    private final JsonBuilderFactory jsonFactory;

    public JsonObjectFromContractNegotiationError(JsonBuilderFactory jsonFactory) {
