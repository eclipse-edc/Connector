...
import org.eclipse.edc.protocol.dsp.spi.config.DefaultTrustedIssuersConfig;
...
import static org.eclipse.edc.protocol.dsp.spi.config.DefaultTrustedIssuersConfig.CONFIG_PREFIX;
...
public class DspApiConfigurationV2025Extension implements ServiceExtension {
    ...
    public void initialize(ServiceExtensionContext context) {
        ...
        var profileContext = new DataspaceProfileContext(DATASPACE_PROTOCOL_HTTP_V_2025_1, V_2025_1,
                () -> dspWebhookAddress.get() + V_2025_1_PATH, participantIdExtractionFunction, DSP_NAMESPACE_V_2025_1,
                List.of(),
                trustedIssuers.values().stream().map(it -> it.createTrustedIssuer(typeManager.getMapper())).toList());
