...
package org.eclipse.edc.protocol.dsp.catalog.transform.v2025.to;
...
class JsonObjectToCatalogTransformerTest {
    ...
    private org.eclipse.edc.protocol.dsp.catalog.transform.v2025.to.JsonObjectToCatalogTransformer transformer;

    @BeforeEach
    void setUp() {
        transformer = new org.eclipse.edc.protocol.dsp.catalog.transform.v2025.to.JsonObjectToCatalogTransformer();
    }
    ...
    void transform_emptyCatalog_returnCatalog() {
        ...
        var result = transformer.transform(TestJsonLd.expand(catalog), context);
    ...
    void transform_invalidType_reportProblem() {
        ...
        transformer.transform(TestJsonLd.expand(catalog), context);
