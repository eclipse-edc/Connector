 ...
 */
public class JsonObjectFromContractRequestMessageV2025Transformer extends AbstractNamespaceAwareJsonLdTransformer<ContractRequestMessage, JsonObject> {

    private final JsonBuilderFactory jsonFactory;

    public JsonObjectFromContractRequestMessageV2025Transformer(JsonBuilderFactory jsonFactory, JsonLdNamespace namespace) {
    ...
    public @Nullable JsonObject transform(@NotNull ContractRequestMessage requestMessage, @NotNull TransformerContext context) {
        ...
        if (requestMessage.getProviderPid() == null) {
