...
class TransferRequestMessageValidatorTest {
    ...
    private final Validator<JsonObject> validator = TransferRequestMessageValidator.instance();

    @Test
    void shouldSucceed_whenObjectIsValid() {
        var input = Json.createObjectBuilder()
                .add(TYPE, Json.createArrayBuilder().add(DSPACE_TYPE_TRANSFER_REQUEST_MESSAGE_IRI))
                .build();
