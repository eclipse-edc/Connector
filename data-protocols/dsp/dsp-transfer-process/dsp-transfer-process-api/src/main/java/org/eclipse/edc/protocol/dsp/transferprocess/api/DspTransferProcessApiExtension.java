...
public class DspTransferProcessApiExtension implements ServiceExtension {
    ...
    public void initialize(ServiceExtensionContext context) {
        var controller = new DspTransferProcessApiController(monitor, typeManager.getMapper(TYPE_MANAGER_CONTEXT_JSON_LD), registry, transferProcessProtocolService, identityService, config.getDspCallbackAddress(), jsonLdService);
