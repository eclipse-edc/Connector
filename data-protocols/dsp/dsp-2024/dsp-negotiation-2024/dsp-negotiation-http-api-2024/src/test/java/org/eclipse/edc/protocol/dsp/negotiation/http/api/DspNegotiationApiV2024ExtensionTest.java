...
class DspNegotiationApiV2024ExtensionTest {
    ...
    void shouldRegisterMessageValidators(DspNegotiationApiV2024Extension extension, ServiceExtensionContext context) {
        ...
        verify(validatorRegistry).register(eq(DSP_NAMESPACE_V_2024_1.toIri(DSPACE_TYPE_CONTRACT_REQUEST_MESSAGE_TERM)), any());
        verify(validatorRegistry).register(eq(DSP_NAMESPACE_V_2024_1.toIri(DSPACE_TYPE_CONTRACT_OFFER_MESSAGE_TERM)), any());
        verify(validatorRegistry).register(eq(DSP_NAMESPACE_V_2024_1.toIri(DSPACE_TYPE_CONTRACT_NEGOTIATION_EVENT_MESSAGE_TERM)), any());
        verify(validatorRegistry).register(eq(DSP_NAMESPACE_V_2024_1.toIri(DSPACE_TYPE_CONTRACT_AGREEMENT_MESSAGE_TERM)), any());
        verify(validatorRegistry).register(eq(DSP_NAMESPACE_V_2024_1.toIri(DSPACE_TYPE_CONTRACT_AGREEMENT_VERIFICATION_MESSAGE_TERM)), any());
        verify(validatorRegistry).register(eq(DSP_NAMESPACE_V_2024_1.toIri(DSPACE_TYPE_CONTRACT_NEGOTIATION_TERMINATION_MESSAGE_TERM)), any());
    }
}
