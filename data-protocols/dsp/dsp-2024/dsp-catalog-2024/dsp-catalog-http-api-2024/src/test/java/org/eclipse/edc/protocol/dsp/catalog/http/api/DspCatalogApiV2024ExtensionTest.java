...
class DspCatalogApiV2024ExtensionTest {
    ...
    @Test
    void shouldRegisterMessageValidator(DspCatalogApiV2024Extension extension, ServiceExtensionContext context) {
        extension.initialize(context);

        verify(validatorRegistry).register(eq(DSP_NAMESPACE_V_2024_1.toIri(DSPACE_TYPE_CATALOG_REQUEST_MESSAGE_TERM)), any());
    }
}
