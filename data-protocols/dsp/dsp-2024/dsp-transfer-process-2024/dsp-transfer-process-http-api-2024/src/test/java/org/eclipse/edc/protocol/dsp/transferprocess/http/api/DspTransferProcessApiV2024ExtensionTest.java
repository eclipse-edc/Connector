...
class DspTransferProcessApiV2024ExtensionTest {
    ...
    void shouldRegisterMessageValidators(DspTransferProcessApiV2024Extension extension, ServiceExtensionContext context) {
        ...
        verify(validatorRegistry).register(eq(DSP_NAMESPACE_V_2024_1.toIri(DSPACE_TYPE_TRANSFER_REQUEST_MESSAGE_TERM)), any());
        verify(validatorRegistry).register(eq(DSP_NAMESPACE_V_2024_1.toIri(DSPACE_TYPE_TRANSFER_START_MESSAGE_TERM)), any());
        verify(validatorRegistry).register(eq(DSP_NAMESPACE_V_2024_1.toIri(DSPACE_TYPE_TRANSFER_COMPLETION_MESSAGE_TERM)), any());
        verify(validatorRegistry).register(eq(DSP_NAMESPACE_V_2024_1.toIri(DSPACE_TYPE_TRANSFER_TERMINATION_MESSAGE_TERM)), any());
    }
