...
/**
 * Provides the transformers for DSP v2024/1 transferprocess message types via the {@link TypeTransformerRegistry}.
 */
...
public class DspTransferProcessTransformV2024Extension implements ServiceExtension {
    ...
    private void registerTransformers() {
        ...
        dspRegistry.register(new JsonObjectFromTransferErrorTransformer(builderFactory, DSP_NAMESPACE_V_2024_1));

        dspRegistry.register(new JsonObjectToTransferRequestMessageTransformer(DSP_NAMESPACE_V_2024_1));
        dspRegistry.register(new JsonObjectToTransferCompletionMessageTransformer(DSP_NAMESPACE_V_2024_1));
        dspRegistry.register(new JsonObjectToTransferStartMessageTransformer(DSP_NAMESPACE_V_2024_1));
