...
class JsonObjectFromContractNegotiationErrorTransformerTest {
    ...
    @BeforeEach
    void setUp() {
        transformer = new JsonObjectFromContractNegotiationErrorTransformer(jsonFactory, DSP_NAMESPACE);
    }
    ...
    void transform_returnJsonObject() {
        ...
        assertThat(result.getJsonString(TYPE).getString()).isEqualTo(DSP_NAMESPACE.toIri(DSPACE_TYPE_CONTRACT_NEGOTIATION_ERROR_TERM));
