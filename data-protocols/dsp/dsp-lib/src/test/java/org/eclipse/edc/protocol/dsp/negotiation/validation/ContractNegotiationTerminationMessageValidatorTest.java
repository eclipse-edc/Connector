...
class ContractNegotiationTerminationMessageValidatorTest {
    ...
    private final Validator<JsonObject> validator = ContractNegotiationTerminationMessageValidator.instance(DSP_NAMESPACE);

    @Test
    void shouldSucceed_whenObjectIsValid() {
        var input = Json.createObjectBuilder()
                .add(TYPE, Json.createArrayBuilder().add(DSP_NAMESPACE.toIri(DSPACE_TYPE_CONTRACT_NEGOTIATION_TERMINATION_MESSAGE_TERM)))
                .build();
