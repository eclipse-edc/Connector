...
class CatalogRequestMessageValidatorTest {
    ...
    private final Validator<JsonObject> validator = CatalogRequestMessageValidator.instance(mock(), DSP_NAMESPACE);

    @Test
    void shouldSucceed_whenObjectIsValid() {
        var input = Json.createObjectBuilder()
                .add(TYPE, Json.createArrayBuilder().add(DSP_NAMESPACE.toIri(DSPACE_TYPE_CATALOG_REQUEST_MESSAGE_TERM)))
                .build();
