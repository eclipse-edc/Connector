...
class JsonObjectToDistributionTransformerTest {
    ...
    private org.eclipse.edc.protocol.dsp.catalog.transform.to.JsonObjectToDistributionTransformer transformer;

    @BeforeEach
    void setUp() {
        transformer = new org.eclipse.edc.protocol.dsp.catalog.transform.to.JsonObjectToDistributionTransformer();
    }
