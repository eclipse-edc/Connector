...
class JsonObjectFromContractOfferMessageV2024TransformerTest {
    ...
    private JsonObjectFromContractOfferMessageV2024Transformer transformer;

    @BeforeEach
    void setUp() {
        transformer = new JsonObjectFromContractOfferMessageV2024Transformer(jsonFactory, DSP_NAMESPACE);
    }
