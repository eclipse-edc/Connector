...
class JsonObjectToContractNegotiationEventMessageTransformerTest {
    ...
    void transform() {
        var message = jsonFactory.createObjectBuilder()
                ...
                .add(DSPACE_PROPERTY_EVENT_TYPE_IRI, DSPACE_VALUE_NEGOTIATION_EVENT_TYPE_ACCEPTED_IRI)
                .build();
    ...
    void verify_failTransformWhenEventTypeMissing() {
        ...
        verify(context, times(1)).reportProblem(contains(DSPACE_PROPERTY_EVENT_TYPE_IRI));
    }
    ...
    void verify_failTransformWhenEventTypeInvalid() {
        var message = jsonFactory.createObjectBuilder()
                ...
                .add(DSPACE_PROPERTY_CONSUMER_PID_IRI, "consumerPid")
                .add(DSPACE_PROPERTY_PROVIDER_PID_IRI, "providerPid")
                .add(DSPACE_PROPERTY_EVENT_TYPE_IRI, "InvalidType")
                .build();
