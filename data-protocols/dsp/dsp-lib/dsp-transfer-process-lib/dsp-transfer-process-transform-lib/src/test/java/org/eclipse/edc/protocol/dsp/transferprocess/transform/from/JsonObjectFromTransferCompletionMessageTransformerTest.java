...
class JsonObjectFromTransferCompletionMessageTransformerTest {
    ...
    private final JsonObjectFromTransferCompletionMessageTransformer transformer =
            new JsonObjectFromTransferCompletionMessageTransformer(jsonFactory, DSP_NAMESPACE);
    ...
    void transformTransferCompletionMessage() {
        ...
        assertThat(result.getString(JsonLdKeywords.TYPE)).isEqualTo(DSP_NAMESPACE.toIri(DSPACE_TYPE_TRANSFER_COMPLETION_MESSAGE_TERM));
