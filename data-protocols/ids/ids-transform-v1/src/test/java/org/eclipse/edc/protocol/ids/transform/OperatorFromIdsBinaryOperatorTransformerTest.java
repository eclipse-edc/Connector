...
class OperatorFromIdsBinaryOperatorTransformerTest {

    // subject
    private OperatorFromIdsBinaryOperatorTransformer transformer;
    ...
    @BeforeEach
    void setUp() {
        transformer = new OperatorFromIdsBinaryOperatorTransformer();

        transformerContext = mock(TransformerContext.class);
    }

    @ParameterizedTest
    @ArgumentsSource(OperatorFromIdsBinaryOperatorTransformerTest.TransformParameterArgumentSource.class)
