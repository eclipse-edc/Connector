...
public class AssetFromIdsRepresentationTransformerTest {
    ...
    private AssetFromIdsRepresentationTransformer transformer;
    ...
    @BeforeEach
    void setUp() {
        transformer = new AssetFromIdsRepresentationTransformer();
