...
class CatalogQueryControllerTest {
    ...
    void queryShouldReturnListOfAssets() {
        ...
        List<Asset> result = (List<Asset>) response.getEntity();
        assertThat(result).containsOnly(asset);
    }
}