 ...
 * and initiates a real TransferProcess so the connector's internal state machine dispatches a
 * {@code DataFlowPrepareMessage} to the TCK data plane registered at startup.
 */
@Path("/")
