...
public class CachedDocumentApiV5EndToEndTest {
    ...
    abstract static class Tests {
        ...
        private CachedDocument inlineContext(String url, String term, String iri) {
        ...
        protected JsonObject requestBody(String url, JsonObjectBuilder content) {
            var builder = createObjectBuilder()
                    ...
                    .add(TYPE, CachedDocument.CACHED_DOCUMENT_TYPE_TERM);
            if (url != null) {
                builder.add("url", url);
            }
            if (content != null) {
        ...
        @AfterEach
        void teardown(ParticipantContextService participantContextService, CachedDocumentStore store) {
        ...
        @Test
        void create(ManagementEndToEndV5TestContext context, CachedDocumentService service) {
            ...
            assertThat(service.findById(id))
                    .isNotNull()
                    .extracting(CachedDocument::getUrl)
        ...
        @Test
        void create_jsonSchema_isStoredWithSchemaType(ManagementEndToEndV5TestContext context, CachedDocumentService service) {
            var requestBody = createObjectBuilder()
                    .add(CONTEXT, jsonLdContext())
                    .add(TYPE, CachedDocument.CACHED_DOCUMENT_TYPE_TERM)
                    .add("url", "https://example.com/schema/person.json")
                    .add("documentType", "JSON_SCHEMA")
                    .add("content", createObjectBuilder().add("type", "object"))
                    .build();
            ...
            assertThat(service.findById(id))
                    .isNotNull()
                    .extracting(CachedDocument::getType)
                    .isEqualTo(CachedDocumentType.JSON_SCHEMA);
        }

        @Test
        void get(ManagementEndToEndV5TestContext context, CachedDocumentService service) {
        ...
        @Test
        void getAll(ManagementEndToEndV5TestContext context, CachedDocumentService service) {
        ...
        @Test
        void update(ManagementEndToEndV5TestContext context, CachedDocumentService service) {
            ...
            assertThat(service.findById(created.getId()))
                    .isNotNull()
                    .extracting(CachedDocument::getContent, org.assertj.core.api.InstanceOfAssertFactories.STRING)
                    .contains("updated");
        }

        @Test
        void delete(ManagementEndToEndV5TestContext context, CachedDocumentService service) {
