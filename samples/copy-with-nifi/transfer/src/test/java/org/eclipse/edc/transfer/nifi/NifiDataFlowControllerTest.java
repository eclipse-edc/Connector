...
import org.eclipse.edc.catalog.atlas.metadata.AtlasDataCatalogEntry;
import org.eclipse.edc.common.annotations.IntegrationTest;
import org.eclipse.edc.dataseed.nifi.api.NifiApiClient;
...
import org.eclipse.edc.schema.SchemaRegistryImpl;
import org.eclipse.edc.schema.azure.AzureBlobStoreSchema;
import org.eclipse.edc.schema.s3.S3BucketSchema;
...
public class NifiDataFlowControllerTest {
    ...
    private static String s3BucketName = "edc-itest";
    ...
    public static void oneTimeSetup() throws Exception {
        ...
        NifiDataFlowControllerTest.containerName = "edc-itest-" + testId;
    ...
    void transfer_multiple_fromAzureToAzure() throws InterruptedException {
        ...
        var destContainerName = "edc-nifi-dest-" + System.currentTimeMillis();
...
//        assertThat(listBlobs(containerName).stream().anyMatch(bi -> bi.getName().equals(secondBlobName))).isTrue();
    ...
    void transfer_all_fromS3_ToS3() throws InterruptedException {
        ...
        var destBucketName = "edc-nifi-dest-" + System.currentTimeMillis();
