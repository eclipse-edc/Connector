...
import org.eclipse.edc.spi.security.VaultEntry;

import static org.eclipse.edc.client.command.http.HttpOperations.executePost;

public class AzureVaultSetSecretRequestExecutor implements org.eclipse.edc.client.command.CommandExecutor {
    @Override
