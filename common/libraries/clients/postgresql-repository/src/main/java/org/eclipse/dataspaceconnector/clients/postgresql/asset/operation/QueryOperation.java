...
public class QueryOperation {
    ...
    public List<Asset> invoke(@NotNull List<Criterion> criteria) throws SQLException {
        ...
        String sqlQueryTemplate = Sql.getAssetQuery();
        String sqlPropertiesByKv = Sql.getPropertiesSelectByKv();
        String sqlPropertiesByAssetId = Sql.getPropertiesSelectByAssetId();
        String sqlAssetsAll = Sql.getAssetSelectAll();
