...
public class UpdateOperation {
    ...
    public void invoke(@NotNull Asset asset) throws SQLException {
        ...
        String sqlAssetExists = Sql.getAssetExists();
        String sqlProperties = Sql.getPropertiesSelectByAssetId();
        String sqlPropertyCreate = Sql.getPropertyCreate();
        String sqlPropertyDelete = Sql.getPropertyDelete();
        String sqlPropertyUpdate = Sql.getPropertyUpdate();
