...
class CachedJsonLdContextServiceImplTest {

    private static final String URL = "https://example.com/context.jsonld";

    private final CachedJsonLdContextStore store = mock();
    private final JsonLdContextResolver resolver = mock();
    private final JsonLd jsonLd = mock();
    private final CachedJsonLdContextServiceImpl service = new CachedJsonLdContextServiceImpl(
    ...
    void create_never_withContent_registersWithoutResolving() {
        var context = CachedJsonLdContext.Builder.newInstance()
                .url(URL)
    ...
    void refresh_always_reResolvesAndReRegisters() {
        var existing = CachedJsonLdContext.Builder.newInstance()
