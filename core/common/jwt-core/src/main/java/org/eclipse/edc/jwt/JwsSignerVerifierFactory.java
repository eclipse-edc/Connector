 ...
 */
public interface JwsSignerVerifierFactory {
     ...
     * @throws IllegalArgumentException if the key is not in the list of supported algorithms ({@link JwsSignerVerifierFactoryImpl#SUPPORTED_ALGORITHMS})
     ...
     */
    JWSVerifier createVerifierFor(PublicKey publicKey);
