...
import org.eclipse.edc.boot.system.testextensions.BaseRuntimeFixture;
...
public class BaseRuntimeTest {
    ...
    private final BaseRuntimeFixture runtime = new BaseRuntimeFixture(monitor, serviceLocator);
    ...
    void baseRuntime_shouldNotBootWithException() {
        ...
        assertThatThrownBy(runtime::start).isInstanceOf(EdcException.class);
