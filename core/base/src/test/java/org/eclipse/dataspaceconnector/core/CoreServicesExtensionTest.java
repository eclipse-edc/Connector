...
class CoreServicesExtensionTest {
    ...
    void provides() {
        ...
        assertThat(provides).containsExactlyInAnyOrder(RetryPolicy.class, HealthCheckService.class, OkHttpClient.class, RemoteMessageDispatcherRegistry.class);
    }
    ...
    void initialize() {
        ...
        verify(context).registerService(eq(RemoteMessageDispatcherRegistry.class), isA(RemoteMessageDispatcherRegistryImpl.class));
