...
class JsonObjectToTerminateNegotiationTransformerTest {

    private final JsonObjectToTerminateNegotiationTransformer transformer = new JsonObjectToTerminateNegotiationTransformer();
    private final TransformerContext context = mock(TransformerContext.class);

    @Test
    void types() {
        assertThat(transformer.getInputType()).isEqualTo(JsonObject.class);
        assertThat(transformer.getOutputType()).isEqualTo(TerminateNegotiation.class);
    }
