...
public class ContractDefinitionServiceImpl implements ContractDefinitionService {
    ...
    @Override
    public ContractDefinition findById(String participantContextId, String contractDefinitionId) {
        return transactionContext.execute(() -> store.findById(participantContextId, contractDefinitionId));
    }
    ...
    @Override
    public ServiceResult<ContractDefinition> delete(String participantContextId, String contractDefinitionId) {
        return transactionContext.execute(() -> {
            var deleteResult = store.deleteById(participantContextId, contractDefinitionId);
