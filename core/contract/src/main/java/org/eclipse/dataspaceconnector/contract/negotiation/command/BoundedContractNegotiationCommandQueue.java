...
public class BoundedContractNegotiationCommandQueue extends BoundedCommandQueue<ContractNegotiationCommand> implements ContractNegotiationCommandQueue {
    
    public BoundedContractNegotiationCommandQueue(int bound) {
        super(bound);
    }
